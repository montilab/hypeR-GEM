...
For detailed information on the study data, downstream analyses, and method-evaluation scripts, please refer to the "Data and Code Availability" section of the manuscript. That section describes where the supporting resources and reproducibility materials can be accessed.
